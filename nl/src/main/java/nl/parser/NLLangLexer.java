...
public class NLLangLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "WS", "COMMENT", "LINE_COMMENT", "LETTER", "NON_ZERO_DIGIT", 
			"DIGIT", "HEX_DIGIT", "OCT_DIGIT", "BINARY_DIGIT", "TAB", "STRING_CHAR", 
			"IdentifierPart", "IdentifierStart", "UnicodeEscapeSequence", "HexDigit", 
	...
	public NLLangLexer(CharStream input) {
		super(input);
